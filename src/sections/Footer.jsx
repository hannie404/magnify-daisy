    ...
    <div className='bg-glass backdrop-blur-2xl'>
      <div className="radial-gradient-bg md:p-10 p-5">
        <div className="flex justify-center items-center">
          <img src="/images/exaltWorshipWhite.png" alt="Exalt Worshiper" className='md:w-52 w-28 border-0 border-r-2 border-white md:p-3 p-2' />
          <div className="flex flex-col md:gap-3 gap-2 md:p-5 p-3">
            <h2 className='font-semibold md:text-base text-xs'>FOLLOW US FOR MORE UPDATES</h2>
