          ...
          <div className="flex flex-col md:gap-3 gap-2 md:p-5 p-3">
            ...
            <div className="flex flex-col md:gap-2 gap-0">
              <div className="flex md:gap-4 gap-2">
                ...
                <p><a href="https://www.facebook.com/ccfexaltworship" target="_blank" className='text-white md:text-base text-xs hover:text-gray-400'>/ccfexaltworship</a></p>
              </div>
              <div className="flex md:gap-4 gap-2">
                <img src="/images/ig.svg" alt="Instagram" className='md:w-auto w-4' />
                <p><a href="https://www.instagram.com/ccfexaltworship" target="_blank" className='text-white md:text-base text-xs hover:text-gray-400'>/ccfexaltworship</a></p>
              </div>
              <div className="flex md:gap-4 gap-2">
                <img src="/images/yt.svg" alt="YouTube" className='md:w-auto w-4' />
                <p><a href="https://www.youtube.com/ccfexaltworship" target="_blank"  className='text-white md:text-base text-xs hover:text-gray-400'>@ccfexaltworship</a></p>
              </div>
            </div>
          </div>
        </div>
